# -*- coding: utf-8 -*-
"""技術Q&A markdown -> PDF。build.py の CSS/HTML/関数を再利用する。"""
import os, sys, json, subprocess, shutil
import build  # reuse fetch_libs, find_chrome, CSS, HTML_TMPL, BUILD

PROJ = build.PROJ
MD_PATH = os.path.join(PROJ, "docs", "発表_開発解説", "技術想定QA_鳩ナビ.md")
OUT_FINAL = os.path.join(PROJ, "docs", "発表_開発解説", "鳩ナビ_技術想定QA.pdf")
OUT_TMP = os.path.join(build.BUILD, "qa_out.pdf")
